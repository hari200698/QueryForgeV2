# Text-to-SQL Agent: Multi-Agent Architecture
...
|---------|-------------|---------|
| `GROQ_MODEL_REASONING` | Model for planning & generation | `llama-3.3-70b-versatile` |
| `GROQ_MODEL_FAST` | Model for schema selection | `llama-3.1-8b-instant` |
...
- [Groq](https://groq.com/) - Language models and lightning-fast inference
